...
animal_sounds = {
    "Buffalo": os.path.join(SOUND_DIR, "Buffalo 1000.wav"),
    "Elephant": os.path.join(SOUND_DIR, "Elephant 4000.wav"),
    "Rhino": os.path.join(SOUND_DIR, "Rhino 2000.wav"),
    "Zebra": os.path.join(SOUND_DIR, "Zebra 4000.wav"),
    "Cheetah": os.path.join(SOUND_DIR, "Cheetah 5000.wav"),
    "Fox": os.path.join(SOUND_DIR, "Fox 20000.wav"),
    "Jaguar": os.path.join(SOUND_DIR, "Jaguar 3000.wav"),
    "Tiger": os.path.join(SOUND_DIR, "Tiger 5000.wav"),
    "Lion": os.path.join(SOUND_DIR, "Lion 6000.wav"),
    "Panda": os.path.join(SOUND_DIR, "Panda 1900.wav")
}
...
def main():
    ...
    st.sidebar.header("**Animal Models**")
    class_names = list(animal_sounds.keys())

    for animal in class_names:
        st.sidebar.markdown(f"- *{animal.capitalize()}*")

    st.title("Wild-Life Guard - Real-time Animal Detection & Repellent Model")
    st.write("This project aims to develop a model for real-time wildlife detection, designed to mitigate wildlife intrusions. This system monitor and identify wildlife presence to prevent potential disturbances.")
