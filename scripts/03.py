...
animal_sounds = {
    "Buffalo": os.path.join(SOUND_DIR, "buffalo.wav"),
    "Elephant": os.path.join(SOUND_DIR, "beep-warning-6387.mp3"),
    "Rhino": os.path.join(SOUND_DIR, "rhino.wav"),
    "Zebra": os.path.join(SOUND_DIR, "zebra.wav"),
    "Cheetah": os.path.join(SOUND_DIR, "cheetah.wav"),
    "Fox": os.path.join(SOUND_DIR, "fox.wav"),
    "Jaguar": os.path.join(SOUND_DIR, "jaguar.wav"),
    "Tiger": os.path.join(SOUND_DIR, "tiger.wav"),
    "Lion": os.path.join(SOUND_DIR, "lion.wav"),
    "Panda": os.path.join(SOUND_DIR, "panda.wav")
}
